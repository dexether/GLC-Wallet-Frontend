                    ...
                    @foreach($sell_data as $key)
                     <tr>
                       ...
                       {{-- <td>{{ number_format($key->original_amount,2) }}</td>
                        ...
                        <td>
                            @if($key->status == 0) <label class="label label-default"> Pending</label>
                            @elseif($key->status == 1)<label class="label label-success">  Success </label>
                            @elseif($key->status == 2)<label class="label label-warning">  Partially </label>
                            @elseif($key->status == 3)<label class="label label-warning">  Cancel </label>
                            @else
                            @endif
                        </td>
                     </tr>
    ...
    <script>
        $(document).ready(function() {
            ...
            function getMessage() {
                ...
                $.ajax({
                    type: 'get',
                    url: '{{url('buycountshow')}}'+'/sell/'+ numItems,
