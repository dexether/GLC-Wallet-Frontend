                        ...
                        <li>
                            <div class="onhover-dropdown">
                                ...
                                <ul class="onhover-show-div">
                                    <li v-on:click="currencycode('BTC')"  ondblclick="call_all_order('BTC')" onclick="call_all('BTC')"><img src="{{ url('/') }}/assets/themes/limitless/images/icon/btc.png" alt="">BTC</li>
                                    <li v-on:click="currencycode('ETH')"  onclick="call_all('ETH')"><img src="{{ url('/') }}/assets/themes/limitless/images/icon/eth.png" alt="">ETH</li>
                                    <li v-on:click="currencycode('LTC')"  onclick="call_all('LTC')"><img src="{{ url('/') }}/assets/themes/limitless/images/icon/ltc.png" alt="">LTC</li>
                                    <li v-on:click="currencycode('XRP')"  onclick="call_all('XRP')"><img src="{{ url('/') }}/assets/themes/limitless/images/icon/xrp.png" alt="">XRP</li>
                                </ul>
                            </div>
                        </li>
                    ...
                    <div class="theme-widget order-widget open">
                        ...
                        <div class="widget-body" style="padding: 5px;">
                            <form class="form-sm">
                                ...
                                <div class="row d-flex">
                                    <div>
                                        <div class="input-group">
                                            <label> Amount AED</label> <span id="approx_usd" style="float: right;"> ≈ @{{amount_aed}} </span>
                                            <input v-model="counter" type="text" class="form-control cust_fld" onkeyup="calculate_price()" name="usd_amount" id="usd_amount" aria-describedby="sizing-addon1">
                                        </div>
                                  </div>
                                    <div>
                                        <div class="input-group">
                                            <label id="coinname"> AMOUNT BTC</label>
                                            <input  v-model="counter1" type="text" name="coin_amount" id="coin_amount"  onkeyup="calculate_price()" class="form-control cust_fld"  aria-describedby="sizing-addon1">
                                        </div>
                                    </div>
                                </div>
                                <div class="row d-flex">
                                ...
                                <div class="row d-flex">
                                    <div>
                                        <label style="color: green;">Pay :<span  id="pay_div">@{{paybuy}}</span> </label><br>
                                        <label style="color: green;">Buy Fees : <b >{{ $buy_fees }}%</b></label>
                                        <button id="buy_button"  :disabled="counter == null"  v-on:click.stop.prevent="placeordersbuy"  type="button"  class="btn btn-success btn-sm btn-block">Exchange Buy</button>
                                    </div>
                                    <div>
                                        <label style="color: green;">Receive :<span  id="rec_div">@{{paysell}}</span></label><br>
                                        <label style="color: green;">Sell Fees: <b>{{ $sell_fees }}%</b></span></label>
                                        <button id="sell_button"  :disabled="counter == null"  v-on:click.stop.prevent="placeordersell" type="button"  class="btn btn-danger btn-sm btn-block">Exchange Sell</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                    ...
                    <div class="">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div @click="$event.target.classList.toggle('open')"  class="theme-widget balance-widget expand-chart"  >
                                    <div class="widget-header acr">
                                                    ...
                                                    <?php  if($exg->side == 'buy') { $color='#fbe9e7'; }
                                                         ...
                                                         <?php $total = ($exg->price) * ($exg->same_price);  ?>
                                                           <tr  style="background-color: <?php echo $color; ?>">
                                                                ...
                                                                <td><lable onclick="cancel_order_user({{$exg->id}},{{$exg->order_id}})  " class="btn btn-info">cancel</lable></td>
                                                               <td>
                                                                   @if($exg->status == 0)
                                    ...
                                    <div class="widget-body">
                                        <div class="">
                                            <div class="">
                                                ...
                                                <div class="col-md-6">
                                             <div class="table-responsive">
                                                 <table id="data-tabl" class="theme-dt bg-success tableclass" style="width:100%">
                                                     <thead>
                                                     <tr>
                                                         <th>Price per BTC</th>
                                                         <th>BTC Amount</th>
                                                    ...
                                                    <div class="col-md-6">
                                                        <table id="data-tabl" class="theme-dt bg-danger tableclass" style="width:100%">
                                                            <thead>
                                                            <tr>
                                                                <th>Price per BTC</th>
                                                                <th>BTC Amount</th>
                                        ...
                                        <div id="myModal" class="modal fade" role="dialog" >
                                            <div class="modal-dialog modal-lg">
                                                ...
                                                <div class="modal-content theme-contant">
                                                    ...
                                                    <div class="">
                                                        <div class="row" class="w-100 p-5">
                                                            <div class="col-md-6">
                                                                <div class="table-responsive">
                                                                    <table id="data-table3" class="theme-dt bg-danger" style="width:100%">
                                                                        <thead>
                                                                        <tr>
                                                                            <th>#</th>
                                                                            <th>AMOUNT</th>
                                                                        ...
                                                                        <tbody>
                                                                        <tr v-for="(value, key, index) in info.data.asks.slice(0,50)" v-on:click="say(value[0],value[1])">
                                                                            <td>  @{{ key+1}}</td>
                                                                            <td>  @{{ value[0]}}</td>
                                                                            <td>  @{{ value[1]}}</td>
                                                                        </tr>
                                                            ...
                                                            <div class="col-md-6">
                                                                <table id="data-table4" class="theme-dt bg-success" style="width:100%">
                                                                    <thead>
                                                                    <tr>
                                                                        <th>#</th>
                                                                        <th>AMOUNT</th>
                                                                    ...
                                                                    <tbody>
                                                                    <tr v-for="(value, key, index) in info.data.bids.slice(0,50)" v-on:click="say(value[0],value[1])">
                                                                        <td>  @{{ key+1}}</td>
                                                                        <td>  @{{ value[0]}}</td>
                                                                        <td>  @{{ value[1]}}</td>
                                                                    </tr>
   ...
   // loadcharts(coin, 'AED');
     ...
     $('#sell_full_coin').empty();
      $('#buy_full_coin').empty();
       ...
       $.ajax({ url: 'exchange/order_middle1/'+coin,  type: 'get',
                  success: function(response) {  $('#order_middle').append(response);  }  });

        $.ajax({ url: 'exchange/order_full1/'+coin, type: 'get',
                  success: function(response) {  $('#order_full').append(response);  }   });

        $.ajax({ url: 'exchange/order_full_block1/'+coin, type: 'get',
                  success: function(response) {  $('#full_block').append(response);  }  });

        $.ajax({ url: 'exchange/buy_full_coin1/'+coin, type: 'get',
                  success: function(response) {  $('#buy_full_coin').append(response);  }  });

       $.ajax({ url: 'exchange/sell_full_coin1/'+coin, type: 'get',
...
<script>
    var countsbids=0;
    var countsasks=0;
    var socket = io('http://139.59.81.237:3000/');
    // var socket = io('http://localhost:3000/');

    //    var socket = io('http://209.97.136.12/cex:3000/api');
    socket.on('msg', function(message){
         countsbids =$('.usersdatabids').length;
         countsasks =$('.usersdataasks').length;
//        /*console.log(message);
//        console.log(countsbids);
//        console.log(countsasks);*/
        console.log(message.data);

        if(countsbids >=10) {
            $('.usersdatabids').last().remove();
            // $('.usersdatabids').last().remove();
        }
        if(countsasks >=40) {

            $('.usersdataasks').last().remove();
        }

        if(message.data.bids) {

             if ((message.data.asks.length  >=1) &&  (message.data.asks[0][1])) {

             var asksrate = 'onclick="setvalue(' + message.data.asks[0][0] + ',' + message.data.asks[0][1] + ')"';
             var markupask = '<tr class="usersdataasks" ' + asksrate + ' > <td>' + message.data.asks[0][0] + '</td><td>' + message.data.asks[0][1] + '</td><td>' + (message.data.asks[0][0] * message.data.asks[0][1]).toFixed(2) +'</td></tr>';

            /* var asksrate = 'onclick="setvalue(' + message.data.asks[1][0] + ',' + message.data.asks[1][1] + ')"';
              markupask += '<tr class="usersdataasks" ' + asksrate + ' > <td>' + message.data.asks[1][0] + '</td><td>' + message.data.asks[1][1] + '</td><td>' + (message.data.asks[1][0] * message.data.asks[1][1]).toFixed(2) +'</td></tr>';
*/
             $("tbody.askshow").prepend(markupask);
             }

            if ((message.data.bids.length  >=1) &&  (message.data.bids[0][1])) {

               var bidsrate = 'onclick="setvalue(' + message.data.bids[0][0] + ',' + message.data.bids[0][1] + ')"';
                var markupbids = '<tr id="'+message.data.bids[0][0]+'" data-number="'+message.data.bids[0][0]+'"  class="usersdatabids" ' + bidsrate + ' > <td>' + message.data.bids[0][0] + '</td><td>' + message.data.bids[0][1] + '</td> <td>' + (message.data.bids[0][0] * message.data.bids[0][1]).toFixed(2) + '</td></tr>';

               /* var bidsrate = 'onclick="setvalue(' + message.data.bids[1][0] + ',' + message.data.bids[1][1] + ')"';
                 markupbids += '<tr class="usersdatabids" ' + bidsrate + ' > <td>' + message.data.bids[1][0] + '</td><td>' + message.data.bids[1][1] + '</td><td>' + (message.data.bids[1][0] * message.data.bids[1][1]).toFixed(2) + '</td></tr>';
*/
                // $("tbody.bidsshow").prepend(markupbids);

                var highestNum1 = message.data.bids[0][0];
                var highestNum =0;
                var set =0;
                ...
                $("tbody.bidsshow .usersdatabids").each(function(){
                    var num = +this.getAttribute("data-number") ;
                    if (num > highestNum)
                        highestNum = num;
                  }).each(function(){
                    if (highestNum1 >= highestNum && set==0 ) {
                        $(this).parent().append(markupbids);
                        $(markupbids).appendTo("'#"+highestNum+"'");
                        $("'#"+highestNum+"'").css("background-color:red");
                        set=1;
                    }
                    else if (highestNum1 < highestNum && set==0) {
                        $(this).parent().prepend(markupbids);
                        $(markupbids).appendTo("'#"+highestNum+"'");
                        $("'#"+highestNum+"'").css("background-color:green");
                        set=1;
                    }
...
//            this.interval = setInterval(function(){
                axios.get('{{url("treading")}}/'+this.currency).then(response => (this.info = response));

//            }.bind(this), 20000);
        },

        methods: {
            democall1: function (message) {
                this.currency =message;
                // console.log(message);
            },
            say: function (message,message1) {
                var buy_fees ={{$buy_fees}};
                var sell_fees ={{$sell_fees}};

                this.counter = message;
                this.counter1 = message1;
                this.feebuy = (((message*message1)*buy_fees)/100).toFixed(4);
                this.feesell = (((message*message1)*sell_fees)/100).toFixed(4);
                this.amount_aed = (message*message1).toFixed(4);
                this.paybuy = (((message*message1)*buy_fees/100)+(message*message1)).toFixed(4);
                this.paysell = (((message*message1)*sell_fees/100)+(message*message1)).toFixed(4);
            },
            currencycode: function (message) {
                this.currency = message;
            },
            placeordersbuy() {
                ...
                axios.post('{{url(('placeordersbuy'))}}', {
                    _token: '{{csrf_token()}}',
                    body: JSON.stringify({ USD: USD, COIN: BTC ,type:this.currency}),
                })
                        .then((response) => {

                            console.log(response);

             var lable = response.data.error;
                ...
                {
                    swal('alert?',response.data.error,'question');
                }
            })
            .catch((error) => {
                    console.log(error);
            ...
            placeordersell() {
                ...
                var USD = $('#usd_amount').val(); var BTC = $('#coin_amount').val();

                axios.post('{{url(('placeordersell'))}}', {
                    _token: '{{csrf_token()}}',
                    body: JSON.stringify({ USD: USD, COIN: BTC ,type:this.currency}),
                })
                        .then((response) => {
    ...
    function cancel_order_user(id,order_id) {
        ...
        $.ajax({
            ...
            success: function (data) {
                console.log(data);
                swal('alert?',data.error,'question');
            }
        });
