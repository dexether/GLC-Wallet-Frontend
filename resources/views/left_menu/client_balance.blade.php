<ul class="media-list media-list-linked media-list-bordered wallet_data" id="media-act">
        ...
        <li class="media {{ Request::path() == 'wallets/aed' ? 'active' : '' }}">
            {{--old--}}
        {{--<li class="media {{ Request::path() == 'wallet/usd' ? 'active' : '' }}">--}}
            <a href="{{url('wallets/aed')}}" class="media-link">
                <div class="media-left">
                    ...
                    @else
                       <img src="{{ url('assets/themes/limitless/images/aed-1.png') }}">
                    @endif
                </div>
                <div class="media-body">

                    <h2>{{$usd->name}} {{trans_choice('general.wallet',1)}}</h2>

                    {{--<span class="display-block text-bold">{{trans_choice('general.balance',1)}}: {{round(\App\Helpers\GeneralHelper::user_currency_balance(Sentinel::getUser()->id,$usd->id),$usd->decimals)}}</span>--}}
                    {{--<span class="display-block text-bold">{{trans_choice('general.locked',1)}}: {{round(\App\Helpers\GeneralHelper::user_currency_balance(Sentinel::getUser()->id,$usd->id),$usd->decimals)}}</span>--}}
                    <span class="display-block text-bold">{{trans_choice('general.balance',1)}}: {{@round(\App\Models\WalletAddress::where('coin','aed')->where("user_id",Sentinel::getUser()->id)->first()->balance)}}</span>
                    {{--<span class="display-block text-bold">{{trans_choice('general.locked',1)}}: {{round(\App\Helpers\GeneralHelper::user_currency_locked_balance(Sentinel::getUser()->id,$usd->id),$usd->decimals)}}</span>--}}
                </div>
            </a>
            <div class="act_btns">

                        {{--<a href="javescript:void();" class="btn btn-default send_rec"><i class="fa fa-paper-plane" aria-hidden="true"></i> Deposit</a>--}}
                        <a href="{{url('wallets/aed/deposit')}}" class="btn btn-default send_rec"><i class="fa fa-paper-plane" aria-hidden="true"></i> Deposit</a>
                        {{--<a href="javescript:void();" class="btn btn-default send_rec"><i class="fa fa-qrcode" aria-hidden="true"></i> Withdraw</a>--}}
                        <a href="{{url('wallets/aed/withdraw')}}" class="btn btn-default send_rec"><i class="fa fa-qrcode" aria-hidden="true"></i> Withdraw</a>
                    </div>
        </li>
        ...
        <li class="media {{ Request::path() == 'wallets/btc' ? 'active' : '' }}">
            <a href="{{url('wallets/btc')}}" class="media-link" >
                <div class="media-left">
                    @if(empty($btc->logo))
                        <svg  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="28px" height="28px" class="img-circle img-xs">
                            <path fill-rule="evenodd"  fill="rgb(245, 195, 61)" d="M14.000,28.000 C6.268,28.000 -0.000,21.732 -0.000,14.000 C-0.000,6.268 6.268,-0.000 14.000,-0.000 C21.732,-0.000 28.000,6.268 28.000,14.000 C28.000,21.732 21.732,28.000 14.000,28.000 ZM19.644,15.576 C19.404,15.169 19.080,14.852 18.670,14.625 C18.387,14.464 17.977,14.315 17.443,14.181 C17.942,14.014 18.342,13.802 18.647,13.546 C18.950,13.289 19.182,12.994 19.345,12.660 C19.506,12.325 19.587,11.972 19.587,11.599 C19.587,11.087 19.434,10.617 19.130,10.188 C18.824,9.759 18.388,9.430 17.821,9.201 C17.492,9.068 17.083,8.978 16.612,8.922 L16.612,7.001 L15.013,7.001 L15.013,8.857 L13.986,8.857 L13.986,7.001 L12.387,7.001 L12.387,8.857 L8.994,8.857 L8.994,10.419 L9.444,10.419 C9.743,10.419 9.947,10.446 10.054,10.500 C10.160,10.553 10.235,10.627 10.279,10.718 C10.323,10.810 10.344,11.023 10.344,11.357 L10.344,17.651 C10.344,17.980 10.322,18.192 10.279,18.286 C10.235,18.381 10.161,18.453 10.054,18.504 C9.947,18.555 9.743,18.582 9.444,18.582 L8.994,18.582 L8.994,20.143 L12.387,20.143 L12.387,21.998 L13.985,21.998 L13.985,20.143 L14.978,20.143 C14.989,20.143 15.001,20.143 15.013,20.143 L15.013,21.998 L16.611,21.998 L16.611,20.051 C17.127,19.985 17.561,19.884 17.907,19.746 C18.574,19.482 19.092,19.098 19.456,18.593 C19.821,18.089 20.004,17.537 20.004,16.938 C20.004,16.438 19.884,15.983 19.644,15.576 ZM15.893,18.205 C15.574,18.294 15.173,18.339 14.689,18.339 L13.855,18.339 C13.577,18.339 13.408,18.324 13.345,18.295 C13.282,18.265 13.238,18.213 13.210,18.137 C13.187,18.077 13.174,17.877 13.168,17.530 L13.168,15.087 L14.646,15.087 C15.294,15.087 15.777,15.147 16.092,15.265 C16.408,15.383 16.645,15.559 16.803,15.791 C16.961,16.024 17.040,16.307 17.040,16.641 C17.041,17.034 16.929,17.371 16.706,17.651 C16.483,17.931 16.212,18.116 15.893,18.205 ZM15.874,13.267 C15.561,13.376 15.076,13.430 14.421,13.430 L13.169,13.430 L13.169,10.678 L14.421,10.678 C15.153,10.678 15.660,10.722 15.944,10.811 C16.228,10.900 16.444,11.051 16.595,11.260 C16.744,11.471 16.820,11.724 16.820,12.022 C16.820,12.307 16.741,12.559 16.582,12.778 C16.424,12.997 16.188,13.160 15.874,13.267 Z"/>
                ...
                <!--    <h2>{{$btc->name}} {{trans_choice('general.wallet',1)}}</h2>-->

                <!--    <span class="display-block text-bold">{{trans_choice('general.balance',1)}}-->
                <!--        : {{round(\App\Helpers\GeneralHelper::user_currency_balance(Sentinel::getUser()->id,$btc->id),$btc->decimals)}}</span>-->
                <!--    <span class="display-block text-bold">{{trans_choice('general.locked',1)}}-->
                <!--        : {{round(\App\Helpers\GeneralHelper::user_currency_locked_balance(Sentinel::getUser()->id,$btc->id),$btc->decimals)}}</span>-->
                <!--</div>-->
                ...
                <div class="media-body">
                    ...
                    <span class="display-block text-bold">{{trans_choice('general.balance',1)}}
                        : {{ number_format(Sentinel::getUser()->bitcoin_balance,8) }}</span>
                    <span class="display-block text-bold">{{trans_choice('general.locked',1)}}
                        : {{round(\App\Helpers\GeneralHelper::user_currency_locked_balance(Sentinel::getUser()->id,$btc->id),$btc->decimals)}}</span>
            ...
            <div class="act_btns">
                        <a href="{{ url('wallets/btc/send') }}" class="btn btn-default send_rec"><i class="fa fa-paper-plane" aria-hidden="true"></i> Send</a>
                        ...
                        <a href="{{ url('wallets/btc') }}" class="btn btn-default send_rec" ><i class="fa fa-qrcode" aria-hidden="true"></i> Receive</a>
                    </div>
        </li>

        @endif
    <!-- @if($dogecoin->active==1)
        <li class="media {{ Request::path() == 'wallet/dogecoin' ? 'active' : '' }}">
            <a href="{{url('wallet/dogecoin')}}" class="media-link">
                <div class="media-left">
                    @if(empty($dogecoin->logo))
                        <svg  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="28px" height="28px" class="img-circle img-xs">
                            <path fill-rule="evenodd"  fill="rgb(245, 195, 61)" d="M14.000,28.000 C6.268,28.000 -0.000,21.732 -0.000,14.000 C-0.000,6.268 6.268,-0.000 14.000,-0.000 C21.732,-0.000 28.000,6.268 28.000,14.000 C28.000,21.732 21.732,28.000 14.000,28.000 ZM19.644,15.576 C19.404,15.169 19.080,14.852 18.670,14.625 C18.387,14.464 17.977,14.315 17.443,14.181 C17.942,14.014 18.342,13.802 18.647,13.546 C18.950,13.289 19.182,12.994 19.345,12.660 C19.506,12.325 19.587,11.972 19.587,11.599 C19.587,11.087 19.434,10.617 19.130,10.188 C18.824,9.759 18.388,9.430 17.821,9.201 C17.492,9.068 17.083,8.978 16.612,8.922 L16.612,7.001 L15.013,7.001 L15.013,8.857 L13.986,8.857 L13.986,7.001 L12.387,7.001 L12.387,8.857 L8.994,8.857 L8.994,10.419 L9.444,10.419 C9.743,10.419 9.947,10.446 10.054,10.500 C10.160,10.553 10.235,10.627 10.279,10.718 C10.323,10.810 10.344,11.023 10.344,11.357 L10.344,17.651 C10.344,17.980 10.322,18.192 10.279,18.286 C10.235,18.381 10.161,18.453 10.054,18.504 C9.947,18.555 9.743,18.582 9.444,18.582 L8.994,18.582 L8.994,20.143 L12.387,20.143 L12.387,21.998 L13.985,21.998 L13.985,20.143 L14.978,20.143 C14.989,20.143 15.001,20.143 15.013,20.143 L15.013,21.998 L16.611,21.998 L16.611,20.051 C17.127,19.985 17.561,19.884 17.907,19.746 C18.574,19.482 19.092,19.098 19.456,18.593 C19.821,18.089 20.004,17.537 20.004,16.938 C20.004,16.438 19.884,15.983 19.644,15.576 ZM15.893,18.205 C15.574,18.294 15.173,18.339 14.689,18.339 L13.855,18.339 C13.577,18.339 13.408,18.324 13.345,18.295 C13.282,18.265 13.238,18.213 13.210,18.137 C13.187,18.077 13.174,17.877 13.168,17.530 L13.168,15.087 L14.646,15.087 C15.294,15.087 15.777,15.147 16.092,15.265 C16.408,15.383 16.645,15.559 16.803,15.791 C16.961,16.024 17.040,16.307 17.040,16.641 C17.041,17.034 16.929,17.371 16.706,17.651 C16.483,17.931 16.212,18.116 15.893,18.205 ZM15.874,13.267 C15.561,13.376 15.076,13.430 14.421,13.430 L13.169,13.430 L13.169,10.678 L14.421,10.678 C15.153,10.678 15.660,10.722 15.944,10.811 C16.228,10.900 16.444,11.051 16.595,11.260 C16.744,11.471 16.820,11.724 16.820,12.022 C16.820,12.307 16.741,12.559 16.582,12.778 C16.424,12.997 16.188,13.160 15.874,13.267 Z"/>
                          </svg>
                    @else
                ...
                <div class="media-body">
                    ...
                    <h2>{{$dogecoin->name}} {{trans_choice('general.wallet',1)}}</h2>

                    <span class="display-block text-bold">{{trans_choice('general.balance',1)}}
                        : {{round(\App\Helpers\GeneralHelper::user_currency_balance(Sentinel::getUser()->id,$dogecoin->id),$dogecoin->decimals)}}</span>
                    <span class="display-block text-bold">{{trans_choice('general.locked',1)}}
                        : {{round(\App\Helpers\GeneralHelper::user_currency_locked_balance(Sentinel::getUser()->id,$dogecoin->id),$dogecoin->decimals)}}</span>
                </div>
            </a>
            <div class="act_btns">
    ...
    @endif -->
    @if($ltc->active==1)
        <li class="media {{ Request::path() == 'wallets/ltc' ? 'active' : '' }}">
            <a href="{{url('wallets/ltc')}}" class="media-link">
                <div class="media-left">
                    @if(empty($ltc->logo))
                        <svg  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="28px" height="28px" class="img-circle img-xs">
                ...
                <div class="media-body">
                    ...
                    <h2>{{$ltc->name}} {{trans_choice('general.wallet',1)}}</h2>

                    <!--<span class="display-block text-bold">{{trans_choice('general.balance',1)}}-->
                    <!--    : {{round(\App\Helpers\GeneralHelper::user_currency_balance(Sentinel::getUser()->id,$ltc->id),$ltc->decimals)}}</span>-->
                    <!--<span class="display-block text-bold">{{trans_choice('general.locked',1)}}-->
                    <!--    : {{round(\App\Helpers\GeneralHelper::user_currency_locked_balance(Sentinel::getUser()->id,$ltc->id),$ltc->decimals)}}</span>-->
                    
                    <span class="display-block text-bold">{{trans_choice('general.balance',1)}}
                        : {{ number_format(Sentinel::getUser()->litecoin_balance,8) }}</span>
                    <span class="display-block text-bold">{{trans_choice('general.locked',1)}}
                        : {{round(\App\Helpers\GeneralHelper::user_currency_locked_balance(Sentinel::getUser()->id,$btc->id),$btc->decimals)}}</span>
                </div>
            </a>
            <div class="act_btns">
                        <a href="{{ url('wallets/ltc/send') }}" class="send_rec"><i class="fa fa-paper-plane" aria-hidden="true"></i> Send</a>
                        ...
                        <a href="{{ url('wallets/ltc') }}" class="send_rec" ><i class="fa fa-qrcode" aria-hidden="true"></i> Receive</a>
                    </div>
        </li>
    @endif
    @if($eth->active==1)
        <li class="media {{ Request::path() == 'wallets/eth' ? 'active' : '' }}">
            <a href="{{url('wallets/eth')}}" class="media-link">
                <div class="media-left">
                    @if(empty($eth->logo))
                        <svg  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="28px" height="28px" class="img-circle img-xs">
                ...
                <div class="media-body">
                    ...
                    <h2>{{$eth->name}} {{trans_choice('general.wallet',1)}}</h2>

                    <!--<span class="display-block text-bold">{{trans_choice('general.balance',1)}}-->
                    <!--    : {{round(\App\Helpers\GeneralHelper::user_currency_balance(Sentinel::getUser()->id,$eth->id),$eth->decimals)}}</span>-->
                    <!--<span class="display-block text-bold">{{trans_choice('general.locked',1)}}-->
                    <!--    : {{round(\App\Helpers\GeneralHelper::user_currency_locked_balance(Sentinel::getUser()->id,$eth->id),$eth->decimals)}}</span>-->
                    
                    <span class="display-block text-bold">{{trans_choice('general.balance',1)}}
                        : {{ number_format(Sentinel::getUser()->ethereum_balance,8) }}</span>
                    <span class="display-block text-bold">{{trans_choice('general.locked',1)}}
                        : {{round(\App\Helpers\GeneralHelper::user_currency_locked_balance(Sentinel::getUser()->id,$btc->id),$btc->decimals)}}</span>
                </div>
            </a>
            <div class="act_btns">
                        <a href="{{ url('wallets/eth/send') }}" class="send_rec"><i class="fa fa-paper-plane" aria-hidden="true"></i> Send</a>
                        ...
                        <a href="{{ url('wallets/eth') }}" class="send_rec"><i class="fa fa-qrcode" aria-hidden="true"></i> Receive</a>
                    </div>
        </li>
    @endif
    @if($xrp->active==1)
        <li class="media  {{ Request::path() == 'wallets/xrp' ? 'active' : '' }}">
            <a href="{{url('wallets/xrp')}}" class="media-link">
                <div class="media-left">
                    @if(empty($xrp->logo))
                        <svg  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="28px" height="28px" class="img-circle img-xs">
                ...
                <div class="media-body">
                    ...
                    <h2>{{$xrp->name}} {{trans_choice('general.wallet',1)}}</h2>

                    <!--<span class="display-block text-bold">{{trans_choice('general.balance',1)}}-->
                    <!--    : {{round(\App\Helpers\GeneralHelper::user_currency_balance(Sentinel::getUser()->id,$xrp->id),$xrp->decimals)}}</span>-->
                    <!--<span class="display-block text-bold">{{trans_choice('general.locked',1)}}-->
                    <!--    : {{round(\App\Helpers\GeneralHelper::user_currency_locked_balance(Sentinel::getUser()->id,$xrp->id),$xrp->decimals)}}</span>-->
                      <span class="display-block text-bold">{{trans_choice('general.balance',1)}}
                        : {{ number_format(Sentinel::getUser()->ripple_balance,8) }}</span>
                    <span class="display-block text-bold">{{trans_choice('general.locked',1)}}
                        : {{round(\App\Helpers\GeneralHelper::user_currency_locked_balance(Sentinel::getUser()->id,$btc->id),$btc->decimals)}}</span>
                </div>
            </a>
            <div class="act_btns">
                        <a href="{{ url('wallets/xrp/send') }}" class="send_rec"><i class="fa fa-paper-plane" aria-hidden="true"></i> Send</a>
                        ...
                        <a href="{{ url('wallets/xrp') }}" class="send_rec" ><i class="fa fa-qrcode" aria-hidden="true"></i> Receive</a>
                    </div>
        </li>
    @endif
</ul>
