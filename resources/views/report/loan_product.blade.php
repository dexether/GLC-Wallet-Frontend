    ...
    <div class="panel panel-white">
        <div class="panel-body table-responsive">
            <table id="reports_table" class="table  table-condensed  table-hover ">
                ...
                @foreach($data as $key)
                    <?php
                    $due_items = \App\Helpers\GeneralHelper::loans_product_total_due_items($key->id, $start_date,
                        $end_date);
                    $principal = $due_items['principal'];
                    $interest = $due_items[ 'interest'];
                    $fees = $due_items['fees'];
                    $penalty = $due_items[ 'penalty'];
                    $principal_payments = \App\Helpers\GeneralHelper::loans_product_total_paid_item($key->id,
                        'principal', $start_date, $end_date);
                    $interest_payments = \App\Helpers\GeneralHelper::loans_product_total_paid_item($key->id, 'interest',
                        $start_date, $end_date);
                    $fees_payments = \App\Helpers\GeneralHelper::loans_product_total_paid_item($key->id, 'fees',
                        $start_date, $end_date);
                    $penalty_payments = \App\Helpers\GeneralHelper::loans_product_total_paid_item($key->id, 'penalty',
                        $start_date, $end_date);
                    ...
                    <tr role="row" class="odd">
                        ...
                        <td style="text-align:right">
                            {{\App\Helpers\GeneralHelper::loans_product_count($key->id,$start_date,$end_date)}}
                        </td>
                        <td style="text-align:right">
                    ...
                    <tr role="row" class="even">
                        ...
                        <td style="text-align:right">
                            {{\App\Helpers\GeneralHelper::payments_product_count($key->id,$start_date,$end_date)}}
                        </td>
                        <td style="text-align:right">
