...
@endsection
@section('content')
<div class="modal fade text-center" id="myModalxrp" role="dialog">
        ...
        <div class="modal-body">
            <div class="p-5">
                <div class="qr_data">
                    <div class="row">
                        <div class="col-sm-12">
                            <h2 class="model-title"><b>Use this address to receive xrp in your wallet</b></h2>
                        </div>
                        <div class="col-sm-12">
                                    <img
        ...
        <div class="col-md-8">
            <div class="btc_wall">
                 <div class="panel panel-white">
                    ...
                    <h6 class="panel-title"> Ripple Wallet<a class="heading-elements-toggle"><i class="icon-more"></i></a></h6>
                </div>
                </div>
                <div class="row">
                    <div class="col-sm-12">
...
@if(!empty($wallet->wallet_id))
          ...
          <form action="{{ url('wallets/show_address') }}" method="post" >
                          {{ csrf_field() }}
                          <input class="form-control cust_fld" id="name" name="coin" value="txrp" type="hidden">
