...
@section('title')
    Litecoin {{trans_choice('general.wallet',1)}}
@endsection
@section('content')
<div class="modal fade text-center" id="myModalltc" role="dialog">
        ...
        <div class="modal-body">
            <div class="p-5">
                <div class="qr_data">
                    <div class="row">
                        <div class="col-sm-12">
                            <h2 class="model-title"><b>Use this address to receive ltc in your wallet</b></h2>
                        </div>
                        <div class="col-sm-12">
                                    <img
        ...
        <div class="col-md-8">
            <div class="btc_wall">
                 <div class="panel panel-white">
                    ...
                    <h6 class="panel-title"> Litecoin Wallet<a class="heading-elements-toggle"><i class="icon-more"></i></a></h6>
                </div>
                </div>
                <div class="row">
                    <div class="col-sm-12">
...
@if(!empty($wallet->wallet_id))
          ...
          <form action="{{ url('wallets/show_address') }}" method="post" >
                          {{ csrf_field() }}
                          <input class="form-control cust_fld" id="name" name="coin" value="tltc" type="hidden">
...
@endif
                    ...
                    <div class="qr_data">
                        <div class="row">
                            <div class="col-sm-3">
                            <img
                                    src="data:image/png;base64, {{DNS2D::getBarcodePNG($wallet->address, "QRCODE",5,5)}}" alt="barcode"/>
                            </div>
                            <div class="col-sm-9">
                        <h4>{{trans_choice('general.my_address',1)}}</h4>
                        <p><b>{{$wallet->address}}</b>
                            @if(\App\Models\Setting::where('setting_key','wallet_address_limit')->first()->setting_value>\App\Models\WalletAddress::where('user_id',Sentinel::getUser()->id)->where('trade_currency_id',$ltc->id)->count())
                                <div class="act_btns withdrw_btc">        
                                    <a href="{{ url('wallet/generate_address?coin=btc') }}"
