...
@section('title')
    Bitcoin {{trans_choice('general.wallet',1)}}
@endsection
@section('content')
<style>
    .border-model{
...
@endif
                    ...
                    <div class="qr_data">
                        ...
                        <p><b>{{$wallet->address}}</b>
                            @if(\App\Models\Setting::where('setting_key','wallet_address_limit')->first()->setting_value>\App\Models\WalletAddress::where('user_id',Sentinel::getUser()->id)->where('trade_currency_id',$btc->id)->count())
                                <div class="act_btns withdrw_btc">        
