...
@section('content')
    <div class="panel panel-white">
        <div class="panel-heading">
            <h6 class="panel-title">{{trans_choice('general.add',1)}} {{trans_choice('general.custom_field',1)}}</h6>
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <label><input class="styled" type="radio" name="required" required value="1"> {{trans_choice('general.yes',1)}}
                </label>
            </div>
            <div class="form-group">
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        <td>
                            <div class="radio">
                                <label>
                                    <input class="styled" type="radio" name="field_type" id="inputType" value="date" required="">
                    ...
                    <tr>
                        <td>
                            <div class="radio">
                                <label>
                                    <input class="styled" type="radio" name="field_type" id="inputType" value="number" required="">
