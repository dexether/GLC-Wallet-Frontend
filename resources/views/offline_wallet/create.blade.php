...
<div class="pageContent">
    ...
    <div class="panel panel-white">
        <div class="panel-heading">
            <h6 class="panel-title">{{trans_choice('general.add',1)}} {{trans_choice('general.wallet',1)}}</h6>
            <div class="heading-elements">

            </div>
        </div>
        {!! Form::open(array('url' => url('offline_wallet/store'), 'method' => 'post', 'name' => 'form',"enctype"=>"multipart/form-data")) !!}
