...
<div style="font-family:Tondo; margin: 20px;">
    <div class="email" >
        ...
        <div class="white-container">
            <h2>{{title_case($exchange->side)}} {{$exchange->coin}} done successfully  </h2>
            <h2 style="font-family: 'Ubuntu', sans-serif;">Hello {{$user->first_name .' ' .$user->last_name}},</h2>
            <h4>your order for {{$exchange->side}} {{$exchange->coin}} done  completed  </h4>
            <h4>your order order id is : {{$exchange->order_id}} </h4>
        </div>
    </div>
</body>
