...
<div style="font-family:Tondo; margin: 20px;">
    <div class="email" >
        ...
        <div class="white-container">
            ...
            <h3>Hello, Your Email {{$user->email}} has been successfully created, You can login now with  Confirm Account , if you need support please send us email suport@exchane.co, Also follow our social media network.</h3>
            <h2>otp code :- {{$user->otp}}</h2>
        </div>
    </div>
</body>
