                                    ...
                                    <li class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                            @if(Sentinel::hasAccess('withdrawals.update'))
                                                <li><a href="{{ url('withdrawal/'.$key->id.'/cancel') }}"
                                                       class="delete">
                                                        {{ trans('general.cancel') }} </a>
                                                </li>
                                                <li><a href="{{ url('withdrawal/'.$key->id.'/pending') }}"
                                                       class="delete">
                                                        {{ trans('general.pending') }} </a>
                                                </li>
                                                <li><a href="{{ url('withdrawal/'.$key->id.'/processing') }}"
                                                       class="delete">
                                                        {{ trans('general.processing') }} </a>
                                                </li>
                                                <li><a href="{{ url('withdrawal/'.$key->id.'/done') }}" class="delete">
                                                        {{ trans('general.done') }} </a>
                                                </li>
                                            @endif
                                            @if(Sentinel::hasAccess('withdrawals.delete'))
                                                <li><a href="{{ url('withdrawal/'.$key->id.'/delete') }}"
