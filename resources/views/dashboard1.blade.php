        ...
        <div class="item layout horizontal center waves-effect" data-currency="btc">
            ...
            <div class="right flex">
                <div class="row">
                    <div class="col xs12 s12 m6 l6 xl6 offset-xs0 offset-s0 offset-m0 offset-l0 offset-xl0 wallet-value">
                        <value>
                            <number style="color: #ffb400;">{{number_format(\App\Helpers\GeneralHelper::user_currency_balance(Sentinel::getUser()->id,$btc->id),2)}}</number>
                        </value>
        ...
        <div class="item layout horizontal center waves-effect" data-currency="usd">
            ...
            <div class="right flex">
                <div class="row">
                    <div class="col xs12 s12 m6 l6 xl6 offset-xs0 offset-s0 offset-m0 offset-l0 offset-xl0 wallet-value">
                        <value>
                            <number style="color: #37c866;">{{number_format(\App\Helpers\GeneralHelper::user_currency_balance(Sentinel::getUser()->id,$usd->id),2)}}</number>
                        </value>
        ...
        <div class="item layout horizontal center waves-effect" data-currency="game">
            ...
            <div class="right flex">
                <div class="row">
                    <div class="col xs12 s12 m6 l6 xl6 offset-xs0 offset-s0 offset-m0 offset-l0 offset-xl0 wallet-value">
                        <value>
                            <number style="color: #98c01f;">{{number_format(\App\Helpers\GeneralHelper::user_currency_balance(Sentinel::getUser()->id,$ltc->id),2)}}</number>
                        </value>
        ...
        <div class="item layout horizontal center waves-effect" data-currency="eth">
            ...
            <div class="right flex">
                <div class="row">
                    <div class="col xs12 s12 m6 l6 xl6 offset-xs0 offset-s0 offset-m0 offset-l0 offset-xl0 wallet-value">
                        <value>
                            <number style="color: #4a90e2;">{{number_format(\App\Helpers\GeneralHelper::user_currency_balance(Sentinel::getUser()->id,$eth->id),2)}}</number>
                        </value>
        ...
        <div class="item layout horizontal center waves-effect" data-currency="bcc">
            ...
            <div class="right flex">
                <div class="row">
                    <div class="col xs12 s12 m6 l6 xl6 offset-xs0 offset-s0 offset-m0 offset-l0 offset-xl0 wallet-value">
                        <value>
                            <number style="color: #ff9639;">{{number_format(\App\Helpers\GeneralHelper::user_currency_balance(Sentinel::getUser()->id,$xrp->id),2)}}</number>
                        </value>
