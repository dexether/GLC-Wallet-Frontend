...
@section('title')
    {{trans_choice('general.deposit',2)}}
@endsection
@section('content')
<div class="pageContent">
    ...
    <div class="panel panel-white">
        <div class="panel-heading">
            <h6 class="panel-title"> {{trans_choice('general.deposit',2)}}</h6>
                                        ...
                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                                @if(Sentinel::hasAccess('deposits.update'))
                                                    <li><a href="{{ url('deposit/'.$key->id.'/cancel') }}" class="delete">
                                                            {{ trans('general.cancel') }} </a>
                                                    </li>
                                                    <li><a href="{{ url('deposit/'.$key->id.'/pending') }}" class="delete">
                                                            {{ trans('general.pending') }} </a>
                                                    </li>
                                                    <li><a href="{{ url('deposit/'.$key->id.'/processing') }}" class="delete">
                                                            {{ trans('general.processing') }} </a>
                                                    </li>
                                                    <li><a href="{{ url('deposit/'.$key->id.'/done') }}" class="delete">
                                                            {{ trans('general.done') }} </a>
                                                    </li>
                                                @endif
                                                @if(Sentinel::hasAccess('deposits.delete'))
                                                    <li><a href="{{ url('deposit/'.$key->id.'/delete') }}"
