            ...
            <div class="pageContent stting">
                <div class="container">
                    ...
                    <div class="panel panel-white">
                        ...
                        {{--{!! Form::open(array('url' => url('setting/update'), 'method' => 'post', 'name' => 'form','class'=>"form-horizontal1","enctype"=>"multipart/form-data")) !!} --}}
                        <div class="panel-body">
                            ...
                            @if(Session::has('flash_notification.message'))
                                <div id="profile_success" class="alert alert-{{ Session::get('flash_notification.level') }}">
                       ...
                       {{-- @if (count($errors) > 0)
                            ...
                            <div class="nav-tabs-custom">
                                <ul class="nav nav-tabs">
                                    <li class="active"><a href="#profile" data-toggle="tab">{{ trans('general.profile') }}</a></li>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane fade in active" id="profile">
                                        ...
                                        {!! Form::open(array('route' => 'updatedata', 'method' => 'POST', 'files' => true)) !!}
                                                ...
                                                <ul>
                                                    <li>
                                                        <div class="formGroup">
                                                            ...
                                                            <input id="nickName" type="text" class="form-control cust_fld" placeholder="Name" name="nickName" value="{{ Sentinel::getUser()->name }}">
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="formGroup">
                                                            <label for="emailFld">Email</label>
                                                            <input id="emailFld" type="email" class="form-control cust_fld" placeholder="Email" name="email" value="{{ Sentinel::getUser()->email }}">
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="formGroup">
                                        ...
                                        {!! Form::open(array('route' => 'updatepersonal', 'method' => 'POST', 'files' => true, 'id' => 'profile-form')) !!}
                                        <div class="settingTabContent">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <div class="personalDtlForm">
                                                            <div class="row">
                                                                <div class="col-sm-6">
                                                                    <div class="form-group">
                                                                        <input type="text" class="form-control cust_fld" placeholder="First Name" name="first_name" value="{{Sentinel::getUser()->first_name}}" >
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-6">
                                                                    <div class="form-group">
                                                                        <input type="text" class="form-control cust_fld" placeholder="Last Name" name="last_name" value="{{Sentinel::getUser()->last_name}}" >
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <?php   $day=''; $month = ''; $year=''; ?>
                                                                @if(Sentinel::getUser()->dob)
                                                                    <?php
                                                                    ...
                                                                    <div class="form-group">
                                                                        <div class="customSelect">
                                                                            <select class="form-control cust_fld" name="day">
                                                                                ...
                                                                                @for($i=1;$i<=31;$i++)
                                                                                    <option value="{{$i}}" @if($i==$day) selected="selected" @endif>{{$i}}</option>
                                                                                @endfor
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-6">
                                                                    <div class="form-group">
                                                                        <input type="text" class="form-control cust_fld" placeholder="City" name="city" value="{{$city}}">
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-6">
                                                                    <div class="form-group">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-6">
                                                                    <div class="form-group" id="" >
                                                                        ...
                                                                        <div class="customSelect">
                                                                            {!! Form::select('country_id',$countries,Sentinel::getUser()->country_id,array('class'=>'form-control select cust_fld','required'=>'required','id'=>'country')) !!}
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                ...
                                <span class="act_btns normalWdBtn rightBtn">
                                  <a href="{{ url('user_bank_account/create') }}" class="btn btn-default send_rec">
                                ...
                                <span class="act_btns normalWdBtn leftBtn">
                                  <a href="{{ url('user_bank_account/data') }}" class="btn btn-default send_rec">
                                    List all accounts
                                </a>
                                </span>
                                            </div>
                            ...
                            -->
                                    ...
                                    <div class="tab-pane fade" id="veryfy_doc">
                                        <div class="settingTabContent">
                                            ...
                                            @if(Sentinel::getUser()->documents_verified==0)
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group" id="">
                                                            ...
                                                            {!! Form::text('dob',Sentinel::getuser()->dob,array('class'=>' cust_fld form-control date-picker','required'=>'required','id'=>'dob')) !!}
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group" id="">
                                                            ...
                                                            <div class="customSelect">
                                                                    ...
                                                                    {!! Form::select('country_id',$countries,Sentinel::getUser()->country_id,array('class'=>'form-control cust_fld','required'=>'required','id'=>'country')) !!}
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group" id="">
                                                            ...
                                                            <input  value="{{$city }}" class="form-control cust_fld" required="required" id="city" name="city" type="text">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group" id="">
                                                            <label for="address" class="control-label">Address</label>
                                                            <input value="{{$street}}" class="form-control cust_fld" required="required" id="address" rows="2" name="address" type="text">
                                                            <input value="{{$street_2}}" class="form-control cust_fld" required="required" id="address" rows="2" name="street_2" type="hidden">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group" id="">
                                                            ...
                                                            <input value="{{$postcode}}" class="form-control cust_fld" id="zip" name="zip" type="text">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group" id="">
                                                            ...
                                                            <div class="customSelect">
                                                                <select class="form-control cust_fld" required="required" id="id_type" name="id_type">
                                                                    ...
                                                                    <option @if(Sentinel::getUser()->id_type == 'id_card' ) selected @endif value="id_card">ID Card</option>
                                                                    <option  @if(Sentinel::getUser()->id_type == 'passport' ) selected @endif   value="passport">Passport</option>
                                                                    <option @if(Sentinel::getUser()->id_type == 'driver_license' ) selected @endif   value="driver_license">Driver License</option></select>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group" id="">
                                                            ...
                                                            <input value="{{Sentinel::getUser()->id_number}}" class="form-control cust_fld" required="required" id="id_number" name="id_number" type="text">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group" id="">
                                                            ...
                                                            @if(Sentinel::getUser()->id_picture)
                                                               <a target="_blank" href="{{URL::asset('uploads/'.Sentinel::getUser()->id_picture)}}">{{Sentinel::getUser()->id_picture}}</a>

                                                               @endif

                                                            <div class="customUpload">
                                                                <input class="form-control"   @if(!Sentinel::getUser()->id_picture) required="required" @endif id="id_picture" name="id_picture" type="file">
                                                        ...
                                                        <div class="form-group" id="">
                                                            ...
                                                            <div class="customSelect">
                                                                <select class="form-control cust_fld" required="required" id="proof_of_residence_type" name="proof_of_residence_type">
                                                                    ...
                                                                    <option @if(Sentinel::getUser()->proof_of_residence_type == 'utility_bill') selected @endif   value="utility_bill">Utility bill</option>
                                                                    <option @if(Sentinel::getUser()->proof_of_residence_type == 'bank_statement') selected @endif value="bank_statement">Bank Statement</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group" id="">
                                                            <label for="proof_of_residence_picture" class="control-label">Proof of residence picture</label>
                                                             ...
                                                             <a  target="_blank" href="{{URL::asset('uploads/'.Sentinel::getUser()->proof_of_residence_picture)}}">{{Sentinel::getUser()->proof_of_residence_picture}}</a>
                                                            @endif

                                                            <div class="customUpload">
                                                                <input class="form-control"  onchange="updateList()"  @if(!Sentinel::getUser()->proof_of_residence_picture) required="required" @endif  id="proof_of_residence_picture" name="proof_of_residence_picture"  onchange="readURL(this);"  type="file">
                                                                <span class="form-control cust_fld">
                                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid" width="17" height="16" viewBox="0 0 17 16">
                                                          <path fill="#92a8c0" d="M13.843,16.000 L3.157,16.000 C1.418,16.000 -0.000,14.564 -0.000,12.794 L-0.000,8.222 C-0.000,7.947 0.216,7.727 0.487,7.727 C0.758,7.727 0.974,7.947 0.974,8.222 L0.974,12.794 C0.974,14.014 1.952,15.011 3.157,15.011 L13.843,15.011 C15.044,15.011 16.026,14.018 16.026,12.794 L16.026,8.295 C16.026,8.020 16.242,7.800 16.513,7.800 C16.784,7.800 17.000,8.024 17.000,8.295 L17.000,12.794 C17.000,14.560 15.586,16.000 13.843,16.000 ZM11.595,4.136 C11.473,4.136 11.346,4.085 11.253,3.990 L8.987,1.689 L8.987,11.724 C8.987,11.999 8.770,12.219 8.500,12.219 C8.229,12.219 8.013,11.999 8.013,11.724 L8.013,1.689 L5.747,3.990 C5.560,4.180 5.249,4.180 5.062,3.990 C4.870,3.796 4.870,3.484 5.062,3.290 L8.157,0.146 C8.247,0.051 8.370,-0.000 8.500,-0.000 C8.626,-0.000 8.752,0.055 8.843,0.146 L11.938,3.290 C12.129,3.484 12.129,3.796 11.938,3.990 C11.844,4.089 11.722,4.136 11.595,4.136 Z" class="cls-1"></path>
                                                        </svg>
                        ...
                        <div class="panel-body">
                            <div class="nav-tabs-custom">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li><a href="#exchange" data-toggle="tab">{{ trans_choice('general.exchange',2) }}</a></li>
                                </ul>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane" id="general">
                                        ...
                                        <div class="form-group">
                                            {!! Form::label('non_reply_email',trans('general.non_reply_email'),array('class'=>'col-sm-2 control-label')) !!}
                                            <div class="col-sm-10">
                                                {!! Form::email('non_reply_email',\App\Models\Setting::where('setting_key','non_reply_email')->first()->setting_value,array('class'=>'form-control','required'=>'required')) !!}
                                            </div>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="tab-pane" id="email_templates">
                                        ...
                                        <div class="form-group">
                                            {!! Form::label('new_account_subject',trans('general.new_account_subject'),array('class'=>'col-sm-3 control-label')) !!}
                                            <div class="col-sm-9">
                                                {!! Form::text('new_account_subject',\App\Models\Setting::where('setting_key','new_account_subject')->first()->setting_value,array('class'=>'form-control')) !!}
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            {!! Form::label('new_account_template',trans('general.new_account_template'),array('class'=>'col-sm-3 control-label')) !!}
                                            <div class="col-sm-9">
                                                {!! Form::textarea('new_account_template',\App\Models\Setting::where('setting_key','new_account_template')->first()->setting_value,array('class'=>'form-control tinymce')) !!}
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            {!! Form::label('withdrawal_paid_email_subject',trans('general.withdrawal_paid_email_subject'),array('class'=>'col-sm-3 control-label')) !!}
                                            <div class="col-sm-9">
                                                {!! Form::text('withdrawal_paid_email_subject',\App\Models\Setting::where('setting_key','withdrawal_paid_email_subject')->first()->setting_value,array('class'=>'form-control')) !!}
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            {!! Form::label('withdrawal_paid_email_template',trans('general.withdrawal_paid_email_template'),array('class'=>'col-sm-3 control-label')) !!}
                                            <div class="col-sm-9">
                                                {!! Form::textarea('withdrawal_paid_email_template',\App\Models\Setting::where('setting_key','withdrawal_paid_email_template')->first()->setting_value,array('class'=>'form-control tinymce')) !!}
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            {!! Form::label('withdrawal_declined_email_subject',trans('general.withdrawal_declined_email_subject'),array('class'=>'col-sm-3 control-label')) !!}
                                            <div class="col-sm-9">
                                                {!! Form::text('withdrawal_declined_email_subject',\App\Models\Setting::where('setting_key','withdrawal_declined_email_subject')->first()->setting_value,array('class'=>'form-control')) !!}
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            {!! Form::label('withdrawal_declined_email_template',trans('general.withdrawal_declined_email_template'),array('class'=>'col-sm-3 control-label')) !!}
                                            <div class="col-sm-9">
                                                {!! Form::textarea('withdrawal_declined_email_template',\App\Models\Setting::where('setting_key','withdrawal_declined_email_template')->first()->setting_value,array('class'=>'form-control tinymce')) !!}
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            {!! Form::label('payment_email_subject',trans('general.payment_email_subject'),array('class'=>'col-sm-3 control-label')) !!}
                                            <div class="col-sm-9">
                                        ...
                                        <div class="form-group">
                                            {!! Form::label('payment_email_template',trans('general.payment_email_template'),array('class'=>'col-sm-3 control-label')) !!}
                                            <div class="col-sm-9">
                                        ...
                                        <div class="form-group">
                                            {!! Form::label('sell_email_subject',trans('general.sell_email_subject'),array('class'=>'col-sm-3 control-label')) !!}
                                            <div class="col-sm-9">
                                                {!! Form::text('sell_email_subject',\App\Models\Setting::where('setting_key','sell_email_subject')->first()->setting_value,array('class'=>'form-control')) !!}
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            {!! Form::label('sell_email_template',trans('general.sell_email_template'),array('class'=>'col-sm-3 control-label')) !!}
                                            <div class="col-sm-9">
                                                {!! Form::textarea('sell_email_template',\App\Models\Setting::where('setting_key','sell_email_template')->first()->setting_value,array('class'=>'form-control tinymce')) !!}
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            {!! Form::label('withdrawal_request_email_subject',trans('general.withdrawal_request_email_subject'),array('class'=>'col-sm-3 control-label')) !!}
                                            <div class="col-sm-9">
                                                {!! Form::text('withdrawal_request_email_subject',\App\Models\Setting::where('setting_key','withdrawal_request_email_subject')->first()->setting_value,array('class'=>'form-control')) !!}
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            {!! Form::label('withdrawal_request_email_template',trans('general.withdrawal_request_email_template'),array('class'=>'col-sm-3 control-label')) !!}
                                            <div class="col-sm-9">
                                                {!! Form::textarea('withdrawal_request_email_template',\App\Models\Setting::where('setting_key','withdrawal_request_email_template')->first()->setting_value,array('class'=>'form-control tinymce')) !!}
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            {!! Form::label('account_accessed_email_subject',trans('general.account_accessed_email_subject'),array('class'=>'col-sm-3 control-label')) !!}
                                            <div class="col-sm-9">
                                                {!! Form::text('account_accessed_email_subject',\App\Models\Setting::where('setting_key','account_accessed_email_subject')->first()->setting_value,array('class'=>'form-control')) !!}
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            {!! Form::label('account_accessed_email_template',trans('general.account_accessed_email_template'),array('class'=>'col-sm-3 control-label')) !!}
                                            <div class="col-sm-9">
                                                {!! Form::textarea('account_accessed_email_template',\App\Models\Setting::where('setting_key','account_accessed_email_template')->first()->setting_value,array('class'=>'form-control tinymce')) !!}
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tab-pane" id="sms_templates">
                                        ...
                                        <div class="form-group">
                                            {!! Form::label('otp_sms_template',trans('general.otp_sms_template'),array('class'=>'col-sm-3 control-label')) !!}
                                            <div class="col-sm-9">
                                                {!! Form::textarea('otp_sms_template',\App\Models\Setting::where('setting_key','otp_sms_template')->first()->setting_value,array('class'=>'form-control','rows'=>'4')) !!}
                                            </div>
                                        </div>
                                    ...
                                    <div class="tab-pane active" id="system">
                                        ...
                                        <div class="form-group">
                                            {!! Form::label('phone_verify',trans('general.phone_verified'),array('class'=>'col-sm-3 control-label')) !!}
                                            <div class="col-sm-9">
                                                {!! Form::select('phone_verify',array('1'=>trans('general.yes'),'0'=>trans('general.no')),\App\Models\Setting::where('setting_key','phone_verify')->first()->setting_value,array('class'=>'form-control')) !!}
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            {!! Form::label('email_verify',trans('general.email_verified'),array('class'=>'col-sm-3 control-label')) !!}
                                            <div class="col-sm-9">
                                                {!! Form::select('email_verify',array('1'=>trans('general.yes'),'0'=>trans('general.no')),\App\Models\Setting::where('setting_key','email_verify')->first()->setting_value,array('class'=>'form-control')) !!}
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            {!! Form::label('documents_verify',trans('general.documents_verified'),array('class'=>'col-sm-3 control-label')) !!}
                                            <div class="col-sm-9">
                                                {!! Form::select('documents_verify',array('1'=>trans('general.yes'),'0'=>trans('general.no')),\App\Models\Setting::where('setting_key','documents_verify')->first()->setting_value,array('class'=>'form-control')) !!}
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            {!! Form::label('auto_email_activation',trans('general.auto_email_activation'),array('class'=>'col-sm-3 control-label')) !!}
                                            <div class="col-sm-9">
                                                {!! Form::select('auto_email_activation',array('1'=>trans('general.yes'),'0'=>trans('general.no')),\App\Models\Setting::where('setting_key','auto_email_activation')->first()->setting_value,array('class'=>'form-control')) !!}
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            {!! Form::label('cancel_withdrawal',trans('general.cancel_withdrawal'),array('class'=>'col-sm-3 control-label')) !!}
                                            <div class="col-sm-9">
                                                {!! Form::select('cancel_withdrawal',array('1'=>trans('general.yes'),'0'=>trans('general.no')),\App\Models\Setting::where('setting_key','cancel_withdrawal')->first()->setting_value,array('class'=>'form-control')) !!}
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            {!! Form::label('notify_withdrawal_request',trans('general.notify_withdrawal_request'),array('class'=>'col-sm-3 control-label')) !!}
                                            <div class="col-sm-9">
                                                {!! Form::select('notify_withdrawal_request',array('1'=>trans('general.yes'),'0'=>trans('general.no')),\App\Models\Setting::where('setting_key','notify_withdrawal_request')->first()->setting_value,array('class'=>'form-control')) !!}
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            {!! Form::label('notify_exchange_complete',trans('general.notify_exchange_complete'),array('class'=>'col-sm-3 control-label')) !!}
                                            <div class="col-sm-9">
                                                {!! Form::select('notify_exchange_complete',array('1'=>trans('general.yes'),'0'=>trans('general.no')),\App\Models\Setting::where('setting_key','notify_exchange_complete')->first()->setting_value,array('class'=>'form-control')) !!}
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            {!! Form::label('wallet_address_limit',trans('general.wallet_address_limit'),array('class'=>'col-sm-3 control-label')) !!}
                                            <div class="col-sm-9">
                                                {!! Form::select('wallet_address_limit',array('1'=>trans('general.yes'),'0'=>trans('general.no')),\App\Models\Setting::where('setting_key','wallet_address_limit')->first()->setting_value,array('class'=>'form-control')) !!}
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            {!! Form::label('wallet_address_source',trans('general.wallet_address_source'),array('class'=>'col-sm-3 control-label')) !!}
                                            <div class="col-sm-9">
                                                {!! Form::select('wallet_address_source',array('1'=>trans('general.online'),'0'=>trans('general.offline')),\App\Models\Setting::where('setting_key','wallet_address_source')->first()->setting_value,array('class'=>'form-control')) !!}
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            {!! Form::label('account_accessed_notification',trans('general.account_accessed_notification'),array('class'=>'col-sm-3 control-label')) !!}
                                            <div class="col-sm-9">
                                                {!! Form::select('account_accessed_notification',array('1'=>trans('general.yes'),'0'=>trans('general.no')),\App\Models\Setting::where('setting_key','account_accessed_notification')->first()->setting_value,array('class'=>'form-control')) !!}
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            {!! Form::label('enable_withdrawal_otp',trans('general.enable_withdrawal_otp'),array('class'=>'col-sm-3 control-label')) !!}
                                            <div class="col-sm-9">
                                                {!! Form::select('enable_withdrawal_otp',array('1'=>trans('general.yes'),'0'=>trans('general.no')),\App\Models\Setting::where('setting_key','enable_withdrawal_otp')->first()->setting_value,array('class'=>'form-control')) !!}
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            {!! Form::label('enable_partial_order_fulfilment',trans('general.enable_partial_order_fulfilment'),array('class'=>'col-sm-3 control-label')) !!}
                                            <div class="col-sm-9">
                                                {!! Form::select('enable_partial_order_fulfilment',array('1'=>trans('general.yes'),'0'=>trans('general.no')),\App\Models\Setting::where('setting_key','enable_partial_order_fulfilment')->first()->setting_value,array('class'=>'form-control')) !!}
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            {!! Form::label('site_online',trans('general.site_online'),array('class'=>'col-sm-3 control-label')) !!}
                                            <div class="col-sm-9">
                                                {!! Form::select('site_online',array('1'=>trans('general.yes'),'0'=>trans('general.no')),\App\Models\Setting::where('setting_key','site_online')->first()->setting_value,array('class'=>'form-control')) !!}
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            {!! Form::label('enable_frontend',trans('general.enable_frontend'),array('class'=>'col-sm-3 control-label')) !!}
                                            <div class="col-sm-9">
                                                {!! Form::select('enable_frontend',array('1'=>trans('general.yes'),'0'=>trans('general.no')),\App\Models\Setting::where('setting_key','enable_frontend')->first()->setting_value,array('class'=>'form-control')) !!}
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            {!! Form::label('order_expire_days',trans('general.order_expire_days'),array('class'=>'col-sm-3 control-label')) !!}
                                            <div class="col-sm-9">
                                                {!! Form::text('order_expire_days',\App\Models\Setting::where('setting_key','order_expire_days')->first()->setting_value,array('class'=>'form-control')) !!}
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            {!! Form::label('enable_google_recaptcha',trans('general.enable_google_recaptcha'),array('class'=>'col-sm-3 control-label')) !!}
                                            <div class="col-sm-9">
                                                {!! Form::select('enable_google_recaptcha',array('1'=>trans('general.yes'),'0'=>trans('general.no')),\App\Models\Setting::where('setting_key','enable_google_recaptcha')->first()->setting_value,array('class'=>'form-control')) !!}
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            {!! Form::label('google_recaptcha_site_key',trans('general.google_recaptcha_site_key'),array('class'=>'col-sm-3 control-label')) !!}
                                            <div class="col-sm-9">
                                                {!! Form::text('google_recaptcha_site_key',\App\Models\Setting::where('setting_key','google_recaptcha_site_key')->first()->setting_value,array('class'=>'form-control')) !!}
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            {!! Form::label('google_recaptcha_secret_key',trans('general.google_recaptcha_secret_key'),array('class'=>'col-sm-3 control-label')) !!}
                                            <div class="col-sm-9">
                                                {!! Form::text('google_recaptcha_secret_key',\App\Models\Setting::where('setting_key','google_recaptcha_secret_key')->first()->setting_value,array('class'=>'form-control')) !!}
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            {!! Form::label('custom_header_javascript',trans('general.custom_header_javascript'),array('class'=>'col-sm-3 control-label')) !!}
                                            <div class="col-sm-9">
                                                {!! Form::textarea('custom_header_javascript',\App\Models\Setting::where('setting_key','custom_header_javascript')->first()->setting_value,array('class'=>'form-control','rows'=>'3')) !!}
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            {!! Form::label('custom_footer_javascript',trans('general.custom_footer_javascript'),array('class'=>'col-sm-3 control-label')) !!}
                                            <div class="col-sm-9">
                                                {!! Form::textarea('custom_footer_javascript',\App\Models\Setting::where('setting_key','custom_footer_javascript')->first()->setting_value,array('class'=>'form-control','rows'=>'3')) !!}
                                            </div>
                                        </div>
                                    ...
                                    <div class="tab-pane" id="exchange">
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                {!! Form::label('cex_username',trans('cex_username'),array('class'=>'col-sm-3 control-label')) !!}
                                                <div class="col-sm-9">
                                                    {!! Form::text('cex_username',\App\Models\Setting::where('setting_key','cex_username')->first()->setting_value,array('class'=>'form-control')) !!}
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                {!! Form::label('cex_api',trans('cex api'),array('class'=>'col-sm-3 control-label')) !!}
                                                <div class="col-sm-9">
                                                    {!! Form::text('cex_api',\App\Models\Setting::where('setting_key','cex_api')->first()->setting_value,array('class'=>'form-control')) !!}
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                {!! Form::label('cex_secret',trans('cex secret'),array('class'=>'col-sm-3 control-label')) !!}
                                                <div class="col-sm-9">
                                                    {!! Form::text('cex_secret',\App\Models\Setting::where('setting_key','cex_secret')->first()->setting_value,array('class'=>'form-control')) !!}
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                {!! Form::label('aed_rate',trans('aed rate'),array('class'=>'col-sm-3 control-label')) !!}
                                                <div class="col-sm-9">
                                                    {!! Form::text('aed_rate',\App\Models\Setting::where('setting_key','aed_rate')->first()->setting_value,array('class'=>'form-control')) !!}
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                {!! Form::label('buy_percentage',trans('buy percentage '),array('class'=>'col-sm-3 control-label')) !!}
                                                <div class="col-sm-9">
                                                    {!! Form::text('buy_percentage',\App\Models\Setting::where('setting_key','buy_percentage')->first()->setting_value,array('class'=>'form-control')) !!}
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                {!! Form::label('sell_percentage',trans('sell percentage '),array('class'=>'col-sm-3 control-label')) !!}
                                                <div class="col-sm-9">
                                                    {!! Form::text('sell_percentage',\App\Models\Setting::where('setting_key','sell_percentage')->first()->setting_value,array('class'=>'form-control')) !!}
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                {!! Form::label('min_BTC',trans('min BTC'),array('class'=>'col-sm-3 control-label')) !!}
                                                <div class="col-sm-9">
                                                    {!! Form::text('min_BTC',\App\Models\Setting::where('setting_key','min_BTC')->first()->setting_value,array('class'=>'form-control')) !!}
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                {!! Form::label('min_ETH',trans('min ETH'),array('class'=>'col-sm-3 control-label')) !!}
                                                <div class="col-sm-9">
                                                    {!! Form::text('min_ETH',\App\Models\Setting::where('setting_key','min_ETH')->first()->setting_value,array('class'=>'form-control')) !!}
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                {!! Form::label('min_XRP',trans('min XRP'),array('class'=>'col-sm-3 control-label')) !!}
                                                <div class="col-sm-9">
                                                    {!! Form::text('min_XRP',\App\Models\Setting::where('setting_key','min_XRP')->first()->setting_value,array('class'=>'form-control')) !!}
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                {!! Form::label('min_LTC',trans('min LTC'),array('class'=>'col-sm-3 control-label')) !!}
                                                <div class="col-sm-9">
                                                    {!! Form::text('min_LTC',\App\Models\Setting::where('setting_key','min_LTC')->first()->setting_value,array('class'=>'form-control')) !!}
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                {!! Form::label('min_USD',trans('min USD'),array('class'=>'col-sm-3 control-label')) !!}
                                                <div class="col-sm-9">
                                                    {!! Form::text('min_USD',\App\Models\Setting::where('setting_key','min_USD')->first()->setting_value,array('class'=>'form-control')) !!}
                                                </div>
                                            </div>
