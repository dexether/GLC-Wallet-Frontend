        ...
        <div class="col-md-8">
            <div class="btc_wall">
                <div class="row">
                                    ...
                                    <table id="data-table" class="table table-striped table-condensed table-hover">
                                        ...
                                        @foreach($deposits as $key)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="https://chain.so/tx/LTC/{{$key->transaction_id}}" target="_blank"> {{ substr($key->transaction_id,0,32) }}...</a>
                                                </td>
                                    ...
                                    <table id="data-table" class="table table-striped table-condensed table-hover">
                                        ...
                                        @foreach($withdrawals as $key)
                                            <tr>
                                                ...
                                                <td>{{ $key->created_at }}</td>
                                                <td>{{ round($key->amount,$btc->decimals) }}</td>
                                                <td>{{round( $key->fee,$btc->decimals) }}</td>
                                                <td>
                                                    @if($key->status=="pending")
                                                        {{trans_choice('general.pending',1)}}
                    ...
                    <div class="col-sm-2">
                        <div class="act_btns withdrw_btc">        
                        <a href="{{ url('wallet/ltc/withdraw') }}"
