...
@section('title')
    {{trans_choice('general.withdraw',1)}}   {{$xrp->name}}
@endsection
@section('content')
<section>
        ...
        <div class="col-md-9">
            <div class="panel panel-white with_drw">
                <div class="panel-heading">
                    <h6 class="panel-title"> {{trans_choice('general.withdraw',1)}}   {{$xrp->name}}</h6>

                    <div class="heading-elements">

                    </div>
                </div>
                {!! Form::open(array('url' => url('wallet/xrp/withdraw/manual'), 'method' => 'post', 'id' => 'withdraw-form',"enctype"=>"multipart/form-data")) !!}
                <input type="hidden" id="network" value="xrp">
                <input type="hidden" id="fee_method" value="{{$xrp->fee_method}}">
                <input type="hidden" id="withdrawal_fixed_fee" value="{{round($xrp->withdrawal_fixed_fee,$xrp->decimals)}}">
                <input type="hidden" id="withdrawal_percentage_fee" value="{{round($xrp->withdrawal_percentage_fee,$xrp->decimals)}}">
                <div class="panel-body ">
