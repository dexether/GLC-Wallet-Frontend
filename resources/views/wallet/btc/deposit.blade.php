        ...
        <div class="col-md-9">
            <div class="panel panel-white">
                <div class="panel-heading">
                    <h6 class="panel-title"> {{trans_choice('general.deposit',1)}}</h6>
                ...
                <div class="panel-body ">
                    ...
                    <div style="display: none" id="manualMethod">
                        <div class="form-group">
                            ...
                            {!! Form::text('account_name',null, array('class' => 'form-control', 'required'=>"required",'id'=>'account_name')) !!}
                        </div>
                        <div class="form-group">
                            {!! Form::label('account_number',trans_choice('general.account',1)." ".trans_choice('general.number',1),array('class'=>'')) !!}
                            {!! Form::text('account_number',null, array('class' => 'form-control', 'required'=>"required",'id'=>'account_number')) !!}
                        </div>
                    </div>
