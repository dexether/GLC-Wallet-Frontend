...
@section('title')
    {{trans_choice('general.withdraw',1)}}   {{$btc->name}}
@endsection
@section('content')
<section>
        ...
        <div class="col-md-8">
            <div class="panel panel-white with_drw">
                <div class="panel-heading">
                    <h6 class="panel-title"> {{trans_choice('general.withdraw',1)}}   {{$btc->name}}</h6>

                    <div class="heading-elements">

                    </div>
                </div>
                {!! Form::open(array('url' => url('wallet/btc/withdraw/manual'), 'method' => 'post', 'id' => 'withdraw-form',"enctype"=>"multipart/form-data")) !!}
                <input type="hidden" id="network" value="btc">
                <input type="hidden" id="fee_method" value="{{$btc->fee_method}}">
                <input type="hidden" id="withdrawal_fixed_fee" value="{{round($btc->withdrawal_fixed_fee,$btc->decimals)}}">
                <input type="hidden" id="withdrawal_percentage_fee" value="{{round($btc->withdrawal_percentage_fee,$btc->decimals)}}">
