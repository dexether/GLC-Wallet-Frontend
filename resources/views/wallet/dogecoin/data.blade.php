...
@section('title')
    Dogecoin {{trans_choice('general.wallet',1)}}
@endsection
@section('content')
<section>
            ...
            <div class="btc_wall">
                <div class="row">
                    <div class="col-sm-10">
                        ...
                        @if(\App\Models\Setting::where('setting_key','wallet_address_limit')->first()->setting_value>\App\Models\WalletAddress::where('user_id',Sentinel::getUser()->id)->where('trade_currency_id',$dogecoin->id)->count())
                            <div class="act_btns withdrw_btc">        
                                    <a href="{{ url('wallet/generate_address?coin=dogecoin') }}"
                                    ...
                                    <table id="data-table" class="table table-striped table-condensed table-hover">
                                        ...
                                        @foreach($deposits as $key)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="https://chain.so/tx/DOGE/{{$key->transaction_id}}"
                    ...
                    <div class="col-sm-2">
                        <div class="act_btns withdrw_btc">        
                        <a href="{{ url('wallet/dogecoin/withdraw') }}"
