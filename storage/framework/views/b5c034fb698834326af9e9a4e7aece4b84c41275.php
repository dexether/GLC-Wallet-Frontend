...
<div style="font-family:Tondo; margin: 20px;">
    <div class="email" >
        ...
        <div class="white-container">
            <h2><?php echo e(title_case($exchange->side)); ?> <?php echo e($exchange->coin); ?> </h2>
            <h2 style="font-family: 'Ubuntu', sans-serif;">Hello <?php echo e($user->first_name .' ' .$user->last_name); ?>,</h2>
            <h4>your order for <?php echo e($exchange->side); ?> <?php echo e($exchange->coin); ?> has been placed we inform you when it completed  </h4>
        </div>
    </div>
</body>
