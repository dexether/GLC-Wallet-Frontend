...
<?php $__env->startSection('title'); ?>
    Bitcoin <?php echo e(trans_choice('general.wallet',1)); ?>
...
<style>
 ...
 <div class="modal fade text-center" id="myModalbtc" role="dialog">
        ...
        <div class="modal-body">
            <div class="p-5">
                <div class="qr_data">
                    <div class="row">
                        <div class="col-sm-12">
                            <h2 class="model-title"><b>Use this address to receive btc in your wallet</b></h2>
                        </div>
                        <div class="col-sm-12">
                                    <img
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="btc_wall">
                    ...
                    <h6 class="panel-title"> Bitcoin Wallet<a class="heading-elements-toggle"><i class="icon-more"></i></a></h6>
                </div>
                </div>
                <div class="row">
                    <div class="col-sm-12">
...
<?php if(!empty($wallet->wallet_id)): ?>
          ...
          <form action="<?php echo e(url('wallets/show_address')); ?>" method="post" >
                          ...
                          <input class="form-control cust_fld" id="name" name="coin" value="tbtc" type="hidden">
...
<?php endif; ?>
                    ...
                    <div class="qr_data">
                        ...
                        <p><b><?php echo e($wallet->address); ?></b>
                            <?php if(\App\Models\Setting::where('setting_key','wallet_address_limit')->first()->setting_value>\App\Models\WalletAddress::where('user_id',Sentinel::getUser()->id)->where('trade_currency_id',$btc->id)->count()): ?>
                                <div class="act_btns withdrw_btc">        
                                    <a href="<?php echo e(url('wallet/generate_address?coin=btc')); ?>"
...
<!--                    <div class="col-sm-2">-->
<!--                        <div class="act_btns withdrw_btc">        -->
<!--                        <a href="<?php echo e(url('wallets/btc/send')); ?>"-->
