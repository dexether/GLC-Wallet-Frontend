...
<head>
    ...
    <link href="<?php echo e(asset('assets/plugins/jstree/themes/default/style.min.css')); ?>" rel="stylesheet" type="text/css"/>
                ...
                <div class="row">
                    <div class="col-lg-4 col-lg-offset-4 col-sm-6 col-sm-offset-3">
                            <div class="text-center">
                                <a href="<?php echo e(url("dashboard")); ?>" class="btn bg-pink-400"><i class="icon-circle-left2 position-left"></i> Back to dashboard</a>
                            </div>
                    </div>
                </div>
                <!-- /error wrapper -->
