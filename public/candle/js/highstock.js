...
(function() {
    ...
    var r, D = document,
        ...
        Yb = /^[0-9]+$/,
        Zb = "stroke-width",
        kb, Na, xb, yb, zb, Wa, lb, mb, Mb, Nb, Ab, Ob, Pb, B = {},
        Q;
    ...
    la.prototype = {
        ...
        buildText: function(a) {
            ...
            !f && !n && e.indexOf(" ") === -1 ? b.appendChild(D.createTextNode(e)) : (h = /<.*style="([^"]+)".*>/, i = /<.*href="(http[^"]+)".*>/, l &&
    ...
    L.prototype = {
        ...
        generatePoints: function() {
            ...
            if (b && (g !== (c = b.length) || j))
                for (m = 0; m < c; m++)
                    if (m === h &&
                        !j && (m += g), b[m]) b[m].destroyElements(), b[m].plotX = r;
            this.data = b;
            this.points = l
        },
    ...
    W.ohlc = x(W.column, {
        lineWidth: 1,
        tooltip: {
            pointFormat: '<span style="color:#333333">â—</span> <b> {series.name}</b><br/>Open: {point.open}<br/>High: {point.high}<br/>Low: {point.low}<br/>Close: {point.close}<br/>'
        },
        states: {
            hover: {
                lineWidth: 3
