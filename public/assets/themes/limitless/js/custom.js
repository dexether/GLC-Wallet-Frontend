...
$('.orderTrigger').click(function(){
  $('.sidebarContent').toggleClass('actOrder');
});


/****** Old footer custom JS ****/
/*
//update main current market prices
    $(document).ready(function (e) {
        // var refreshId = setInterval(function () {
            $.ajax({
                url:"{{url('market/latest_price')}}", dataType: "json", success: function (result) {
                    $(".current_btcusd_price").html(result.btcusd);
                    $(".current_ltcusd_price").html(result.ltcusd);
                    $(".current_dogecoinusd_price").html(result.dogecoinusd);
                    $(".current_xrpusd_price").html(result.xrpusd);
                    $(".current_ethusd_price").html(result.ethusd);
                }
            });
        }, 9000);
    })*/
